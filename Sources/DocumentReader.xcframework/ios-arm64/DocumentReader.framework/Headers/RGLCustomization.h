...
@class RGLUIConfiguration;

/// Tags can be used to override SDK's camera view controller buttons. Hide overroden button via RGLFunctionality.
typedef NS_ENUM(NSInteger, RGLCustomButtonTag) {
  RGLCustomButtonTagClose = 1001,
  RGLCustomButtonTagTorch = 1002,
  RGLCustomButtonTagCapture = 1003,
  RGLCustomButtonTagChangeFrame = 1004,
  RGLCustomButtonTagSkipNextPage = 1005,
...
@property(nonatomic, assign) BOOL showResultStatusMessages RGL_DEPRECATED(8.1, "Result status message is removed");

/// Allows you to set any NSString to the status.
@property(nonatomic, strong, nullable) NSString *status;

/// Allows you to set any NSString to the result status.
@property(nonatomic, strong, nullable) NSString *resultStatus RGL_DEPRECATED(8.1, "Result status message is removed");
...
/// i.e. (800 / 2) * 0.5 = 200 px. If the multiplier is equal to 1, the message will be centered.
/// If the multiplier is equal to zero, the default location will be used. Default: 0.
@property(nonatomic, assign) CGFloat resultStatusPositionMultiplier RGL_DEPRECATED(8.1, "Result status message is removed");
...
@property(nonatomic, strong, null_resettable) UIColor *resultStatusTextColor RGL_DEPRECATED(8.1, "Result status message is removed");

/// Allows you to set a font for the result status messages.
@property(nonatomic, strong, null_resettable) UIFont *resultStatusTextFont RGL_DEPRECATED(8.1, "Result status message is removed");

/// Allows you to set a color of the background for the result status messages.
@property(nonatomic, strong, nullable) UIColor *resultStatusBackgroundColor RGL_DEPRECATED(8.1, "Result status message is removed");
...
@property(nonatomic, assign) CGFloat activityIndicatorPortraitPositionMultiplier;

/// Allows you to set an offset for the activity indicator (landscape orientation).
/// If not set, activity indicator always centered in the camera border.
@property(nonatomic, assign) CGFloat activityIndicatorLandscapePositionMultiplier;
...
/// Allows you to set a color for the "Skip next page" button text.
@property(nonatomic, strong, nullable) UIColor *multipageButtonTextColor;

/// Allows you to set a font for the "Skip next page" button text.
@property(nonatomic, strong, nullable) UIFont *multipageButtonTextFont;

/// Allows you to set a title for the "Skip next page" button.
...
@property(nonatomic, assign) CGFloat previewLayerPositionMultiplier;
