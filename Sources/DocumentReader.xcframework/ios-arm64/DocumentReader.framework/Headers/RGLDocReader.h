...
typedef void (^RGLDocumentReaderFinalizePackageCompletion)(RGLDocReaderAction action,
                                                           RGLTransactionInfo * _Nullable info,
                                                           NSError * _Nullable error) NS_SWIFT_NAME(DocumentReaderFinalizePackageCompletion);
...
@protocol RGLDocReaderDatabaseFetchDelegate <NSObject>
@optional
