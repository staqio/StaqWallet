...
typedef NS_ENUM(NSInteger, RGLLCID) {
  ...
  RGLLCIDBengaliBangladesh = 2117,
  RGLLCIDBengaliIndia = 1093,
...
typedef NS_ENUM(NSInteger, RGLGraphicFieldType) {
    ...
    /**
     Contact chip
    */
    RGLGraphicFieldTypeGf_ContactChip        = 213,
    /**
     Other image type
     */
