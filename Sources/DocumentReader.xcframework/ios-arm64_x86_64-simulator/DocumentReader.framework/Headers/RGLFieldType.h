...
typedef NS_ENUM(NSInteger, RGLFieldType) {
    ...
    RGLFieldTypeFt_DLClassCode_RM_From = 651,
    /// DL class code RM notes
    RGLFieldTypeFt_DLClassCode_RM_Notes = 652,
    /// DL class code RM valid to
    RGLFieldTypeFt_DLClassCode_RM_To = 653,
    /// DL class code PW valid from
    RGLFieldTypeFt_DLClassCode_PW_From = 654,
    /// DL class code PW notes
    RGLFieldTypeFt_DLClassCode_PW_Notes = 655,
    /// DL class code PW valid to
    RGLFieldTypeFt_DLClassCode_PW_To = 656,
    
    RGLFieldTypeFt_DLClassCode_EB_From = 657,
    
    RGLFieldTypeFt_DLClassCode_EB_Notes = 658,
    
    RGLFieldTypeFt_DLClassCode_EB_To = 659,
    
    RGLFieldTypeFt_DLClassCode_EC_From = 660,
    
    RGLFieldTypeFt_DLClassCode_EC_Notes = 661,
    
    RGLFieldTypeFt_DLClassCode_EC_To = 662,
    
    RGLFieldTypeFt_DLClassCode_EC1_From = 663,
    
    RGLFieldTypeFt_DLClassCode_EC1_Notes = 664,
    
    RGLFieldTypeFt_DLClassCode_EC1_To = 665,
    
    RGLFieldTypeFt_Place_Of_Birth_City = 666,
  
    RGLFieldTypeFt_Year_Of_Birth = 667,
  
    RGLFieldTypeFt_Year_Of_Expiry = 668,
  
    RGLFieldTypeFt_GrandfatherName_Maternal = 669,

    RGLFieldTypeFt_First_Surname = 670,

    RGLFieldTypeFt_Month_of_Birth = 671,

    RGLFieldTypeFt_Address_Floor_Number = 672,

    RGLFieldTypeFt_Address_Entrance = 673,

    RGLFieldTypeFt_Address_Block_Number = 674,

    RGLFieldTypeFt_Address_Street_Number = 675,

    RGLFieldTypeFt_Address_Street_Type = 676,

    RGLFieldTypeFt_Address_City_Sector = 677,

    RGLFieldTypeFt_Address_County_Type = 678,

    RGLFieldTypeFt_Address_City_Type = 679,

    RGLFieldTypeFt_Address_Building_Type = 680,
    
    RGLFieldTypeFt_Date_of_Retirement = 681,
