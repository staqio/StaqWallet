...
@property (readonly, nonatomic, strong, nullable) NSString *sessionLogFolder RGL_DEPRECATED(7.6, "Use `DocumentReaderResults.transactionInfo.sessionLogFolder` instead.");;
