...
// Generated by Apple Swift version 6.4 effective-5.10 (swiftlang-6.4.0.33.1 clang-2100.3.33.1)
#ifndef STAQWALLET_SWIFT_H
#define STAQWALLET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StaqWallet",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
